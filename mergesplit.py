...
"}")
    ...
    def proceedButton_2_connect(self):
        if self.res:
            ...
            output_filename, format = QFileDialog.getSaveFileName(QtWidgets.QDialog(), "Save splitted file", self.res[0]+"_splitted", "PDF Files (*.pdf)")
            ...
            if output_filename:
                with open(output_filename, 'wb') as output_file:
                    ...
                    path = os.path.join("recent_file", file_name)
                    try:
                        # Try to open the file
                        with open(path, 'rb') as my_file:
                            # Read the content or perform any necessary operations
                        ...
                        print("File not found. Creating a new PDF file...")

                        # Create a new PDF file and save it
                        create_pdf(path)
                        with open(path, 'wb') as my_file:
                            writer.write(my_file)
        else:
